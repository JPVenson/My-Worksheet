...
[ScopedService]
public class MorestachioDocumentationProvider
{
    private readonly MustachioFormatterService _mustachioFormatterService;

    public MorestachioDocumentationProvider(MustachioFormatterService _mustachioFormatterService)
    {
        this._mustachioFormatterService = _mustachioFormatterService;
    }

    public IDictionary<string, object> GetMorestachioFormatterDocumentation()
    {
        return GetMorestachioFormatterDocumentation(null);
    }

    public IDictionary<string, object> GetMorestachioFormatterDocumentation(string filter)
    {
        ...
        var sourceServices = ObjectFormatter.Combine(formatterService.Services.Enumerate(), DefaultFormatterService.Default.Value.Services.Enumerate());
