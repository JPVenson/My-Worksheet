...
{
    public ApiResult(HttpStatusCode statusCode, bool success, string statusMessage, object errorResult, ExceptionDispatchInfo exception = null)
    {
...
{
    public ApiResult(HttpStatusCode statusCode, bool success, string statusMessage, object errorResult, ExceptionDispatchInfo exception)
    {
        StatusCode = statusCode;
        Success = success;
        StatusMessage = statusMessage;
