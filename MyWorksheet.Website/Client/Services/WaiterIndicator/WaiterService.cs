...
namespace MyWorksheet.Website.Client.Services.WaiterIndicator;
...
public class WaiterService
{
    ...
    public void DisplayOk(LocalizableString display = null)
    {
    ...
    public void DisplayError(LocalizableString display = null)
    {
        var badge = new BadgeDisplay()
        {
