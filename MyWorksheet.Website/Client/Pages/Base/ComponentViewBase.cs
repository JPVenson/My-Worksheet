    ...
    INotifyPropertyChanging
{
    ...
    public ChangeAdapter WhenChanged<TList>(IFutureList<TList> changed)
    {
        return TrackWhen().Changed(changed);
    }

    public ChangeAdapter WhenChanged(ILazyLoadedService service)
    {
        return TrackWhen().Changed(service);
    }
